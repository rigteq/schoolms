...
async function main() {
    console.log("🌱 Starting Seed 2.0 (2 Schools, 2 Admins, 2 Teachers, 4 Students each)...");
    ...
    // Helper to create user (Admin/Teacher)
    const createAuthUser = async (email: string, name: string, roleName: 'Admin' | 'Teacher', schoolId: string) => {

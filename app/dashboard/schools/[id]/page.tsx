...
import { fetchSchoolDetailWithRelationsAction } from "@/app/actions/data-actions";
...
export default function SchoolDetailPage() {
    ...
    const fetchSchoolDetails = async () => {
        ...
        setLoading(true);
        try {
            const data = await fetchSchoolDetailWithRelationsAction(id as string);
    ...
    const handleDelete = async () => {
        ...
        try {
            await deleteRecordAction("schools", id as string);
